...
%%
%% Manages the counter, param, and table guardian supervisor trees.
-module(gr_sup).
...
init([]) ->
    ...
    GuardianSup = ?CHILD(gr_guardian_sup, supervisor),
    {ok, {{one_for_one, 50, 10}, [CounterSup, ParamSup, GuardianSup]}}.
